...
{
    internal class ConfigurationReceiver : BackgroundService
    {
        ...
        public ConfigurationReceiver(HttpClient httpClient, ILogger logger = null)
        {
            _httpClient = httpClient;
            this.logger = logger ?? new Logger();

            _socket = new SocketIOClient.SocketIO(configUrl, new SocketIOClient.SocketIOOptions
            {
